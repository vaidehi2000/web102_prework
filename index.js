...
function filterUnfundedOnly() {
    ...
    console.log("Unfunded:", unfundedGames.length); // for key
}
...
function filterFundedOnly() {
    ...
    console.log("Funded:", fundedGames.length); // for key
}
...
const description = `A total of $${totalRaised.toLocaleString("en-US")} has been raised for ${GAMES_JSON.length} games. Currently, there ${unfundedCount === 1 ? "is" : "are"} ${unfundedCount} unfunded ${unfundedCount === 1 ? "game" : "games"}.`;
